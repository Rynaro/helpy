...
class CategoriesController < ApplicationController
  ...
  before_action :filtering_categories, only: ['index','show']
  ...
  def filtering_categories
    if params[:internal]
      @categories = Category.is_internal.active.ordered.with_translations(I18n.locale)
      @page_title = I18n.t :internal_knowledgebase, default: "Internal Knowledgebase"
    else
      @categories = Category.is_public.active.ordered.with_translations(I18n.locale)
